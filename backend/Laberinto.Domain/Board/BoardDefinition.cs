...
public sealed class BoardDefinition
{
    ...
    private static IReadOnlyDictionary<MagicSymbol, Position> CreateFixedSymbolPositions()
    {
        ...
        {
            [MagicSymbol.Symbol01] = new(0, 2),
            [MagicSymbol.Symbol02] = new(0, 3),
            [MagicSymbol.Symbol03] = new(1, 1),
            [MagicSymbol.Symbol04] = new(1, 2),
            [MagicSymbol.Symbol05] = new(1, 3),
            [MagicSymbol.Symbol06] = new(1, 4),
            [MagicSymbol.Symbol07] = new(2, 0),
            [MagicSymbol.Symbol08] = new(2, 1),
            [MagicSymbol.Symbol09] = new(2, 2),
            [MagicSymbol.Symbol10] = new(2, 3),
            [MagicSymbol.Symbol11] = new(2, 4),
            [MagicSymbol.Symbol12] = new(2, 5),
            [MagicSymbol.Symbol13] = new(3, 0),
            [MagicSymbol.Symbol14] = new(3, 1),
            [MagicSymbol.Symbol15] = new(3, 2),
            [MagicSymbol.Symbol16] = new(3, 3),
            [MagicSymbol.Symbol17] = new(3, 4),
            [MagicSymbol.Symbol18] = new(3, 5),
            [MagicSymbol.Symbol19] = new(4, 1),
            [MagicSymbol.Symbol20] = new(4, 2),
            [MagicSymbol.Symbol21] = new(4, 3),
            [MagicSymbol.Symbol22] = new(4, 4),
            [MagicSymbol.Symbol23] = new(5, 2),
            [MagicSymbol.Symbol24] = new(5, 3)
        };
