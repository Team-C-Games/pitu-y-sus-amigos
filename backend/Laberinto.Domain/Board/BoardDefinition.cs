...
public sealed class BoardDefinition
{
    ...
    private static IReadOnlyDictionary<MagicSymbol, Position> CreateFixedSymbolPositions()
    {
        var positions = new Dictionary<MagicSymbol, Position>
        {
            ...
            [MagicSymbol.Symbol08] = new(2, 2),
            [MagicSymbol.Symbol09] = new(2, 3),
            [MagicSymbol.Symbol10] = new(2, 4),
            [MagicSymbol.Symbol11] = new(2, 5),
            [MagicSymbol.Symbol12] = new(3, 0),
            [MagicSymbol.Symbol13] = new(3, 1),
            [MagicSymbol.Symbol14] = new(3, 2),
            [MagicSymbol.Symbol15] = new(3, 3),
            [MagicSymbol.Symbol16] = new(3, 4),
            [MagicSymbol.Symbol17] = new(3, 5),
            [MagicSymbol.Symbol18] = new(4, 1),
            [MagicSymbol.Symbol19] = new(4, 2),
            [MagicSymbol.Symbol20] = new(4, 3),
            [MagicSymbol.Symbol21] = new(4, 4),
